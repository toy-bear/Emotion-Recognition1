...
class Emotion_Rec:
    def __init__(self, model_path=None):
        ...
        # 载入人脸表情识别模型
        self.emotion_classifier = tf.keras.models.load_model(emotion_model_path, compile=False)
        # 表情类别
    ...
    def run(self, frame_in, canvas, label_face, label_result):
        ...
        if len(faces) > 0:
            ...
            for i in range(len(faces)):  # 遍历每张检测到的人脸，默认识别全部人脸
                ...
                roi = preprocess_input(roi)   #调用load_and_process中的preprocess_input（）函数
